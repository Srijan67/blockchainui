      ...
      <div className="carousel">
        <Slider {...settings}>
          <div className="pl-0 md:pl-28 items-center grid grid-cols-2 headarea md:grid-cols-2 md:justify-evenly">
            <h1 className="headtextShadow md:text-5xl text-2xl md:pt-44 text-white font-bold md:text-left md:pl-16 md:-translate-y-28 md:leading-normal tracking-wide text-center leading-normal pb-0">
              MERKLABS BLOCKCHAIN <br />
              DEVELOPMENT AND <br />
              SECURITY SOLUTIONS{" "}
            </h1>
            <img
              className="explorebtn cursor-pointer text-center m-auto pt-6 w-1/3 md:pl-16 md:m-0 md:pb-0 md:mt-0 md:text-left md:pt-0"
              alt="explore button"
              srcSet={ExploreBtn}
            />
          </div>
          <h1 className=" headtextShadow md:text-5xl text-2xl md:pt-44 text-white font-bold md:text-left md:pl-44 md:-translate-y-28 md:leading-normal tracking-wide text-center leading-normal pb-0">
            MERKLABS BLOCKCHAIN <br />
            DEVELOPMENT AND <br />
            SECURITY SOLUTIONS{" "}
          </h1>
