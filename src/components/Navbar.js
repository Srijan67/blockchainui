    ...
    <Popover className="relative text-white ">
      <div className=" mx-auto sm:px-6 my-nav">
        <div className="md:h-1/5 flex justify-between items-center md:justify-start md:space-x-10 pt-8 md:pt-12 md:pl-10">
          ...
          <Popover.Group
            as="nav"
            className="relative z-20 hidden md:flex space-x-10 md:w-full flex-1 md:justify-center md:items-center"
          >
          ...
          <img
            className="hidden md:block h-fit w-32 absolute md:right-44 top-6 right-4"
            srcSet={NavLinkImage}
            alt="nav image print"
          />
        </div>
